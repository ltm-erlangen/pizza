...
e_bond, e_pair, e_total, pressure, step, temperature = l.get(
...
print()
print(
    " Block    Samples Temperature      E_bond      E_pair",
...
for i in range(nblocks):
    ...
    print(
        " %5i %10i %11.2f %11.2f %11.2f %11.2f %11.2f %11.2f"
        % (
            i + 1,
            samples,
            temperature_ave[i],
...
print(
    " Ave.             %11.2f %11.2f %11.2f %11.2f %11.2f %11.2f"
    % (
        grand_ave_temperature,
        grand_ave_e_bond,
        grand_ave_e_pair,
        grand_ave_e_total,
        grand_ave_pressure,
...
print(
    " Stdev            %11.2f %11.2f %11.2f %11.2f %11.2f %11.2f"
    % (
        stdev_temperature,
        stdev_e_bond,
        stdev_e_pair,
