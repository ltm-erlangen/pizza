...
class vcr:
    ...
    def __init__(self, *views):
        ...
        self.slider_quality = Scale(
            frame2, from_=3, to=12, orient=HORIZONTAL, label="       Quality"
        )
        self.slider_quality.bind("<ButtonRelease-1>", self.q)
        self.slider_quality.set(5)
        self.slider_delay = Scale(
            frame2,
            from_=0.0,
            to=1.0,
            resolution=0.1,
        ...
        frame3 = Frame(root)
        self.slider_xlo = Scale(
            frame3,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipxlo,
            orient=HORIZONTAL,
            showvalue=0,
            label="       xclip",
        )
        self.slider_ylo = Scale(
            frame3,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipylo,
            orient=HORIZONTAL,
            showvalue=0,
            label="       yclip",
        )
        self.slider_zlo = Scale(
            frame3,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipzlo,
            orient=HORIZONTAL,
            showvalue=0,
            label="       zclip",
        )
        ...
        frame4 = Frame(root)
        self.slider_xhi = Scale(
            frame4,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipxhi,
            orient=HORIZONTAL,
            showvalue=0,
        )
        self.slider_yhi = Scale(
            frame4,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipyhi,
            orient=HORIZONTAL,
            showvalue=0,
        )
        self.slider_zhi = Scale(
            frame4,
            from_=0.0,
            to=1.0,
            resolution=0.01,
            command=self.clipzhi,
            orient=HORIZONTAL,
            showvalue=0,
        )
