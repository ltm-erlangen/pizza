        ...
        for index in vlist:
            ...
            if obj.style == GROUP:
                if not obj.on_id:
                    ...
                    print(
                        "particles %s %d %s" % (obj.id, obj.npart, obj.on_id), file=fp
                    )
                print(file=fp)
                for i in range(obj.npart):
...
class Surface:
    ...
    def inside_prep(self):
        ...
        print(
            "Binning %d triangles into %d by %d bins ..."
